  ...
  */
  ...
  export interface LinkDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends LinkAggregateArgs>(args: Subset<T, LinkAggregateArgs>): Promise<GetLinkAggregateType<T>>
  ...
  export class Prisma__UserClient<T> implements Promise<T> {
    ...
    links<T extends LinkFindManyArgs = {}>(args?: Subset<T, LinkFindManyArgs>): CheckSelect<T, Promise<Array<Link>>, Promise<Array<LinkGetPayload<T>>>>;
